                ...
                position: function (pos, params, dom, rect, size) {
                    ...
                    if (data) {
                        ...
                        obj['right'] = (
                            data.name.length > 65 ?
                                5 :
                                size.viewSize[0] - pos[0] - size.contentSize[0] - 10
                        );
                    } else {
                        // 没有data，是legend上的tooltip
                        // 鼠标在左侧时 tooltip 显示到右侧，鼠标在右侧时 tooltip 显示到左侧。
                        obj['top'] = params.name.length > 300 ? 1 : pos[1] + 15;
                        obj['left'] = (
                            params.name.length > 65 ?
                                5 :
                                pos[0] - size.contentSize[0] - 10
                        );
                    }
                    return obj;
                },
                // formatter: function (params, name) {
                //     //换行
                //     let split = [];
                //     for (let i = 0; i < params.name.length; i + 65) {
                //         split.push(params.name.slice(i, i + 65).replace(`<token>`, '< token>'));
                //         i += 65;
                //     }
                ...
                feature:
                    {
                        ...
                        myTool2: {
                            show: false,
                            title:
                                IntlFormatMessage('common.preview'),
                            icon:
                        ...
                        myTool1: {
                            show: false,
                            title:
                                IntlFormatMessage('common.threshold'),
                            icon:
                        ...
                        myTool3: {
                            show: false,
                            title:
                                IntlFormatMessage('common.savegenericity'),
                            icon:
                        ...
                        saveAsImage: {
                            show: false,
                            title:
                                IntlFormatMessage('common.saveAsimage'),
                        }
                        ,
                        myTool4: {
                            show: false,
